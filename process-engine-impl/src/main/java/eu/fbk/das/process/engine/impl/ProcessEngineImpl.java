...
public class ProcessEngineImpl implements ProcessEngine {
    ...
    private ArrayListMultimap<DomainObjectInstance, String> msgQueue = ArrayListMultimap
	    .create();
	...
	if (!proc.isRunning()) {
	    logger.debug("Impossible run process with pid " + proc.getpid()
		    + " because is terminated");
	    remove(proc);
	    return;
	}
