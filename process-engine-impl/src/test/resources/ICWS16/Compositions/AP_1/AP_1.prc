...
<ns2:process xmlns:ns2="http://docs.oasis-open.org/wsbpel/2.0/process/executable">
    <ns2:sequence>
        <ns2:invoke>
            <name>FC_DriverLoginRequest</name>
            <order>0</order>
        </ns2:invoke>
        <ns2:reply>
            <name>FC_DriverLoginAck</name>
            <order>1</order>
        </ns2:reply>
        <ns2:invoke>
            <name>FC_RouteAssignmentRequest</name>
            <order>2</order>
        </ns2:invoke>
        <ns2:reply>
            <name>FC_RouteAssignmentReply</name>
            <order>3</order>
        </ns2:reply>
        <ns2:switch xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="processActivity">
            <name>FC_TakeFlexibus</name>
            <order>4</order>
        </ns2:switch>
    </ns2:sequence>
</ns2:process>
