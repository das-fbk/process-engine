...
import eu.fbk.das.process.engine.api.composition.element.exceptions.InvalidServiceActionException;
import eu.fbk.das.process.engine.api.composition.element.exceptions.InvalidServiceCurrentStateException;
import eu.fbk.das.process.engine.api.composition.element.exceptions.InvalidServiceInitialStateException;
import eu.fbk.das.process.engine.api.composition.element.exceptions.InvalidServiceTransitionException;
import eu.fbk.das.process.engine.api.composition.element.exceptions.ServiceDuplicateActionException;
...
public class ServiceDiagram {
    ...
    public ServiceDiagram(String sid, String type, String entity,
	    ...
	    Set<String> outputs, Set<String> abstracts,
	...
	for (ServiceTransition tr : transitions) {
		...
		throw new InvalidServiceTransitionException();
	    }
	}
	...
	try {
	    ...
	    sd = new ServiceDiagram(this.sid, this.type,
		    ...
		    outputs, abstracts, transitions, false);
