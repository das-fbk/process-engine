 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="stateVariable" type="{http://das.fbk.eu/DataType}variableType" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
public class DomainObject {
    ...
    protected DomainObject.State state;
    @XmlElement(namespace = "http://das.fbk.eu/DomainObject", required = true)
     ...
     * @return
     *     possible object is
     *     {@link DomainObject.State }
     *     
     */
    public DomainObject.State getState() {
        return state;
    }
     ...
     *     
     */
    public void setState(DomainObject.State value) {
        this.state = value;
    }
    ...
    public static class State {
        ...
        @XmlElement(namespace = "http://das.fbk.eu/DomainObject", required = true)
        protected List<VariableType> stateVariable;
         ...
         * 
         */
        public List<VariableType> getStateVariable() {
            if (stateVariable == null) {
                stateVariable = new ArrayList<VariableType>();
            }
