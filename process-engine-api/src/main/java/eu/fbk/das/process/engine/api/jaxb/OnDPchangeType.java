...
public class OnDPchangeType {
    ...
    protected List<OnDPchangeType.DomainProperty> domainProperty;
     ...
     * 
     */
    public List<OnDPchangeType.DomainProperty> getDomainProperty() {
        if (domainProperty == null) {
            domainProperty = new ArrayList<OnDPchangeType.DomainProperty>();
        }
